...
AddEventHandler("menu:test" , function(parameter)
    TriggerEvent('chat:addMessage', {
        color = { 255, 0, 0},
        args = {"[pepe-MENU]", "Hey, menu test with specific parameter: "..parameter}
      })
...
--     exports['pepe-menu']:SetTitle("Example Title")
--     exports['pepe-menu']:AddButton("Example Button Title1" , "Description" ,'menu:test' ,'example button 1' , 'me')
--     exports['pepe-menu']:AddButton("Example Button Title2" , "Description" ,'menu:test' ,'example button 2' , "menuone" )
--     exports['pepe-menu']:AddButton("Example Button Title3" , "Description" ,'menu:test' ,'example button 3' , "me" )
--     exports['pepe-menu']:SubMenu("One" , "Description" , "menuone" )
--     exports['pepe-menu']:SubMenu("Two" , "Description" , "me" )
-- end)
