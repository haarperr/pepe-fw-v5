...
function DrawTarget()
    ...
    if DeliveriesCount == 4 then
        TriggerEvent('pepe-phone:client:completedjob', source)
        RemoveCancelBlip()
      ...
      if pizza == 1 then
        TriggerEvent('pepe-phone:client:oneleft', source)
      else
        if pizza == 4 then
          pizza = 'Four'
        elseif pizza == 3 then
        ...
        --TriggerEvent('pepe-phone:client:delivery', source)
      end
        if LastGoal == RandomPoint then
            ...
            TriggerEvent('pepe-phone:client:deliverto', source)
        end
    end
end
            ...
            if Delivered then
                ...
                if DistanceFromCancelZone <= 2.5 then
                    ...
                    if DistanceFromCancelZone <= 7 then
                        if IsControlJustReleased(0, 46) then
                            TriggerEvent('pepe-phone:client:canceledjob', source)
							EndOfWork()
                        end
                    end
                end
...
function EndOfWork()
    ...
    if IsPedInAnyVehicle(ped, false) then
        ...
        if IsVehicleModel(Van, GetHashKey('panto')) then
            ...
            TriggerEvent('pepe-phone:client:vehicleinfo', source)
        end
    else
        InService = false
        BlipSell = nil
