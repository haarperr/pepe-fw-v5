            ...
            if dist < 2 then
                if PlayerJob ~= nil then
                    if PlayerJob.name == "cardealer" then
                        ...
                        DrawText3Ds(PepeCustoms.ShowroomPositions[ClosestCustomVehicle].coords.x, PepeCustoms.ShowroomPositions[ClosestCustomVehicle].coords.y, PepeCustoms.ShowroomPositions[ClosestCustomVehicle].coords.z + 1.75, '~b~/sellvehicle [id]~w~ -Sell vehicle ~b~/Testdrive~w~ - Arrange test drive')
