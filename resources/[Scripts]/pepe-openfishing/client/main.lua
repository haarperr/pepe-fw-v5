...
RegisterNetEvent("pepe-openfishing:tryToFish")
AddEventHandler("pepe-openfishing:tryToFish", function()
	TryToFish() 
end)

RegisterNetEvent("pepe-openfishing:calculatedistances")
AddEventHandler("pepe-openfishing:calculatedistances", pos, function()
