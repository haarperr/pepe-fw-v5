...
RegisterNUICallback('save', function(data)
    Framework.Functions.TriggerCallback('qb-tunerchip:server:HasChip', function(HasChip)
        if HasChip then
            ...
            setVehData(veh, data)
            Framework.Functions.Notify('OutcastTuning v1.05: Vehicle adapted!', 'error')
...
RegisterNUICallback('reset', function(data)
    ...
    local veh = GetVehiclePedIsUsing(ped)
    resetVeh(veh)
    Framework.Functions.Notify('OutcastTuning v1.05: Vehicle has been reset!', 'error')
end)
...
AddEventHandler('qb-tunerchip:client:openChip', function()
    ...
    if inVehicle then
        Framework.Functions.Progressbar("connect_laptop", "Connecting..", 2000, false, true, {
