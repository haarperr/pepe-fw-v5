...
Config.Menus = {
    ...
    ['main'] = {
        title = '',
        options = {
            {label = 'Repair', img = 'img/icons/repair.png', price = 250, onSelect = function() repairtVehicle(customVehicle) end},
        ...
        ['upgrade'] = {
            title = 'UPGRADES',
            options = {
                {label = 'Engine', img = 'img/icons/engine.png', modType = 11, priceMult = {0.0, 3.25, 7.5, 12.0, 15.0, 19.0}},
                {label = 'Brakes', img = 'img/icons/brakes.png', modType = 12, priceMult = {0.0, 1.5, 4.0, 7.0, 10.0}},
                {label = 'Transmission', img = 'img/icons/transmission.png', modType = 13, priceMult = {0.0, 2.25, 4.5, 6.75, 9.0}},
                {label = 'Suspension', img = 'img/icons/suspension.png', modType = 15, priceMult = {0.0, 1.5, 3.0, 4.5, 6.0, 7.5, 9.0}},
                {label = 'Armor', img = 'img/icons/armor.png', modType = 16, priceMult = {0.0, 5.0, 10.0, 17.5, 22.0, 25.0, 30.0, 35.0}},
                {label = 'Turbo', img = 'img/icons/engine.png', modType = 18, priceMult = {0.0, 15.0}},
            },
